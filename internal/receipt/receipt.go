...
func (document Receipt) Validate() error {
	...
	if !requestKinds[document.RequestKind] || !envelope.IsDigest(document.ReplayKey) || !envelope.IsDigest(document.RequestDigest) || !envelope.IsDigest(document.RequestDocumentDigest) {
	...
	if document.RequestKind == "scorer_result" {
		if document.TeamID == nil || document.AttemptID == nil || document.QuotaCharged || document.ScorerResultDigest == nil || *document.ScorerResultDigest != document.RequestDocumentDigest || document.ReservationReceiptDigest == nil {
